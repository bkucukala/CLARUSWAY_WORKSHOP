...
```text
NAME                     PROVISIONER             RECLAIMPOLICY   VOLUMEBINDINGMODE      ALLOWVOLUMEEXPANSION   AGE
aws-standard (default)   kubernetes.io/aws-ebs   Delete          WaitForFirstConsumer   false                  21m
gp2 (default)            kubernetes.io/aws-ebs   Delete          WaitForFirstConsumer   false                  46m
```

```bash
kubectl delete storageclass aws-standart
```
...
PS: Before create these objects, to be able to create pv, please remove aws-standart storage class
```bash
cd ..
